...
// The evidence says what tied the two companies, not who. It used to print the
// head officer's name, and the public redaction removes `headOfficer` but never
// looked inside this sentence: 55 cards in the published feed named 33 people
// through it. The person stays on `headOfficer`, which the private path keeps
// and the public feed drops.
export const VIA_EVIDENCE = 'HPD names the same head officer for both';
