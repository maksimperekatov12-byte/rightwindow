...
// The re-check (lib/recheck.mjs) asks the same question of a host: a
// directory's homepage says nothing about any one listing on it.
export const isDirectoryHost = (host) => DIRECTORY_HOSTS.test(String(host || ''));
