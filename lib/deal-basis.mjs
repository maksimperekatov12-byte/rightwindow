 ...
 */
export function defaultCapacity(weeksToDeadline) {
  if (!Number.isFinite(weeksToDeadline) || weeksToDeadline <= 0) return 40;
  return Math.max(8, Math.min(48, Math.round(weeksToDeadline * 1.6)));
}
