...
export const TRADE_UNITS = {
  ...
  gas: {
    ...
    plumber:  { unit: 10000, basis: 'assumption', recurring: 'four years', what: 'inspection plus the repair it opens' },
    // No trade, no number: the register keeps its lead fact and prices nothing.
    explore:  { basis: 'none', what: 'pick a trade to price it' },
  ...
  openings: {
    // No blended "venue setup" for a visitor with no trade: a venue is a
    // recurring account and its value depends entirely on what you sell it.
    // No unit here means the register leads with its fact (the city-printed
    // phone numbers) and shows no money until a trade is chosen.
    _default:  { basis: 'none', what: 'pick a trade to price it' },
